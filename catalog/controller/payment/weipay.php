...
class ControllerPaymentWeipay extends Controller {
    ...
    $this->data['button_confirm'] = $this->language->get('button_confirm');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/weipay.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/weipay.tpl';
		} else {
			$this->template = 'default/template/payment/weipay.tpl';
		}
			...
			elseif($notify->data["result_code"] == "FAIL"){
				...
				if ($order_info) {
					...
					if (!$order_status_id) {
						...
						$this->model_checkout_order->confirm($order_id, $this->config->get('weipay_order_status_id'));
					}else{
