...
<div class="content"><?php echo $content_top; ?>
      ...
      <div class="list-block media-list">
        <ul>
          <li class="item-content">
            <a href="<?php echo $product['href']; ?>"><div class="item-media">
              <img src="<?php echo $product['thumb']; ?>" width="44">
            </div></a>
            <div class="item-inner">
              <div class="item-title-row">
                <div class="item-title price">单价：<?php echo $product['price']; ?></div>
              </div>
              <div class="item-subtitle">数量：<br>
              <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" style="display: flex">
              <input class="min button button-fill button-success" name="" type="button" value="-" style="width: 30%"/>
              <input class="text_box" name="quantity[<?php echo $product['key']; ?>]" type="text" value="<?php echo $product['quantity'];?>" style="text-align: center; height: 1.5rem; width: 2rem"/>
              <input class="add button button-fill button-success" name="" type="button" value="+" style="width: 30%"/>&nbsp;&nbsp;&nbsp;
  ...
  <?php }?>
  <div class="row">
    <div class="col-50"><a href="<?php echo $checkout; ?>" class="button button-fill button-danger"><?php echo $button_checkout; ?></a></div>
    <div class="col-50"><a href="<?php echo $continue; ?>" class="button button-fill button-danger"><?php echo $button_shopping; ?></a></div>
  </div>            
